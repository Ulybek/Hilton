  ...
  return (
    <>
      ...
      <div className='contact-box'>
        <a href="#"><p>Сообщить о проблеме</p><img src={`${import.meta.env.BASE_URL}public/images/arrow.png'`} /></a>
        <a href="#"><p>Техническая помощь в номере</p><img src={`${import.meta.env.BASE_URL}publuc/images/arrow.png'`} /></a>
      </div>
    </>
  );
}